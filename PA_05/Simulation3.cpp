...
/**
  * @file Simulation3.cpp
  *
  * @brief Implementation file for Simulation3 class
  *
  * @author Alex Kastanek
  *
  * @details Implements all member methods of the Simulation3 class
  *
  * @version 1.00
  *  		 C.S. Student (15 November 2016)
  *			 Initial development and testing of Simulation3 class
  *
  * @note Requires Simulation3.h
  *
  * @note None
  *
  */
...
/**
  ...
  * @note: None
  */
void Simulation3::getArrivals(char* fileName)
{
...
/**
  ...
  * @note: None
  */
int Simulation3::getTellerAvailability()
{
...
/**
  ...
  * @note: None
  */
void Simulation3::processArrival(Queue<Event>& arrivalQueue, Queue<Event>& eventQueue, Queue<Event>& bankLine, Queue<int>& departureQueue)
{
...
/**
  ...
  * @note: None
  */
void Simulation3::processDeparture(Queue<Event>& arrivalQueue, Queue<Event>& eventQueue, Queue<Event>& bankLine, Queue<int>& departureQueue)
{
