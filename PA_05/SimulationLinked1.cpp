...
/**
  * @file SimulationLinked1.cpp
  *
  * @brief Implementation file for SimulationLinked1 class
  *
  * @author Alex Kastanek
  *
  * @details Implements all member methods of the SimulationLinked1 class
  *
  * @version 1.00
  *  		 C.S. Student (15 November 2016)
  *			 Initial development and testing of SimulationLinked1 class
  *
  * @note Requires SimulationLinked1.h
  *
  * @note None
  *
  */
...
/**
  * @brief Constructor for class SimulationLinked1
  *
  * @details Able to construct a SimulationLinked1 object
  *
  * @pre None
  *
  * @post None
  ...
  * @note: None
  */
SimulationLinked1::SimulationLinked1(int a)
{
	firstSim = 0;
...
/**
  * @brief Destructor for class SimulationLinked1
  *
  * @details Able to destruct a SimulationLinked1 object
  *
  * @pre None
  *
  * @post None
  ...
  * @note: None
  */
SimulationLinked1::~SimulationLinked1()
{
...
/**
  ...
  * @note: None
  */
void SimulationLinked1::getArrivals(char* fileName)
{
...
/**
  ...
  * @note: None
  */
void SimulationLinked1::simulate()
{
	...
	while (!arrivalQueue.isEmpty())
	{
		...
		//cout << arrivalTime << " " << departureTime << " " << transactionTime << endl;
...
/**
  ...
  * @note: None
  */
void SimulationLinked1::processArrival(LinkedListQueue<Event>& arrivalQueue, LinkedListQueue<Event>& eventQueue, LinkedListQueue<Event>& bankLine, LinkedListQueue<int>& departureQueue)
{
...
/**
  ...
  * @note: None
  */
void SimulationLinked1::processDeparture(LinkedListQueue<Event>& arrivalQueue, LinkedListQueue<Event>& eventQueue, LinkedListQueue<Event>& bankLine, LinkedListQueue<int>& departureQueue)
{
